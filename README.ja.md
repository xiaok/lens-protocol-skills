...
| プロンプト | 効果 |
|-----------|------|
| `Lens で投稿を作成して公開して` | 投稿の完全なフローを生成 |
| `画像をアップロードしてリンクを教えて` | Grove アップロードコードを生成 |
| `個人ブログを作って` | 完全な個人ブログアプリを生成 |
| `Privy ログイン付きのゲームフォーラムを作って。フルUI、投稿一覧/投稿/返信/タグベースグループ、Slay the Spire 風のUIでゲーマーを惹きつけて` | 完全なゲーミングコミュニティアプリを生成 |
